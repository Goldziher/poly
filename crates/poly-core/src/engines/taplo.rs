    ...
    fn option_keys(&self, table: OptionTable) -> OptionKeys {
        match table {
            OptionTable::Format => OptionKeys::declared(&[
                ("column_width", OptionType::INTEGER),
                ("indent_width", OptionType::INTEGER),
                ("allowed_blank_lines", OptionType::INTEGER),
                ("align_entries", OptionType::BOOLEAN),
                ("align_comments", OptionType::BOOLEAN),
                ("reorder_keys", OptionType::BOOLEAN),
                ("indent_tables", OptionType::BOOLEAN),
                ("indent_entries", OptionType::BOOLEAN),
                ("array_trailing_comma", OptionType::BOOLEAN),
                ("array_auto_expand", OptionType::BOOLEAN),
                ("array_auto_collapse", OptionType::BOOLEAN),
                ("compact_arrays", OptionType::BOOLEAN),
                ("compact_inline_tables", OptionType::BOOLEAN),
                ("inline_table_expand", OptionType::BOOLEAN),
            ]),
